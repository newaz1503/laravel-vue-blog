                            ...
                            <form role="form" @submit.prevent="updatePost()" enctype="multipart/form-data">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="file" name="image" v-model="form.image" @change="imageChange($event)">
                                        <HasError :form="form" field="image" />
                                        <img v-if="form.image" :src="imageRender()" alt="" width="120" height="80">
                                    </div>
                                </div>
                                <!-- /.card-body -->
...
<script>
    export default {
        ...
        methods:{
            ...
            updatePost(){
                this.form.post('/admin/post/update/'+this.$route.params.id)
                    .then(res => {
